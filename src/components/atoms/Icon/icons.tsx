...
export const iconPaths: Record<IconName, ReactNode> = {
  ...
  // WhatsApp contact affordance (SHU-030) — floating button, header/footer
  // links. A generic chat-bubble glyph (paired with the "WhatsApp"
  // accessible name/label for meaning), not a reproduction of Meta's
  // trademarked logo artwork.
  whatsapp: (
    <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" />
  ),
  // Process-roadmap step icons (services page "Our Process") — a neutral
  // message-square (distinct from whatsapp's rounded chat-bubble glyph)
  // and a standard calendar glyph.
  chat: (
